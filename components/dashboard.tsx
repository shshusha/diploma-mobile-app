...
import { AlertTriangle, MapPin, Users, Shield, Clock, CheckCircle } from "lucide-react"
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Overview of all users in the safety monitoring system</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {users?.map((user) => (
